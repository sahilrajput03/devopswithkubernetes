...
// Sahil notes:
// Refer official examples from k8's github repo:
// https://github.dev/kubernetes-client/javascript/tree/master/examples

// Q. Why are we even usig json-streaming library?
// src: vvvvvv tldr: Ensures individual JSON objects are recognized. The concatenation of two JSON objects does not produce a valid JSON object so we need such libraries. ~ Wikipedia
// https://en.wikipedia.org/wiki/JSON_streaming

// In above program request is made to url:
// https://0.0.0.0:35455/apis/stable.dwk/v1/countdowns?watch=true
// https://0.0.0.0:35455/apis/batch/v1/jobs?watch=true

// ~Sahil: From direct command line you access k8 api commands via:
// Directly accessing api (official docs): https://kubernetes.io/docs/tasks/administer-cluster/access-cluster-api/#directly-accessing-the-rest-api

// kubectl proxy --port=8080 &
// curl http://localhost:8080/apis/batch/v1/jobs?watch=true
